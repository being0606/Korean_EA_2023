...
g.add_argument("--model-path", type=str, default="monologg/kobert", help="model file path")
g.add_argument("--tokenizer", type=str, default="monologg/kobert", help="huggingface tokenizer path")
